...
This clamps job_similarity and each match’s similarity into [0,1][0,1] before scoring, so misbehaving upstream code (e.g., returning -0.2 or 1.4) can’t silently distort the score.
...
### DEFAULT_PREFERRED_BONUS_MAX_FRACTION = 0.08
...
### DEFAULT_MISSING_REQUIRED_PENALTY_MAX = 40.0 (ratio-based)
...
### DEFAULT_PER_MISSING_REQUIRED_PENALTY = 3.0 (count-based)
...
If you tell me your desired interpretation of scores (e.g., “70 = acceptable, 85 = strong”), I can suggest initial tuning ranges for these constants so the score distribution matches that meaning.
