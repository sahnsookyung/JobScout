...
@app.function(
    ...
    container_idle_timeout=60,      # spin down after 1 min of inactivity to save cost (tradeoff: cold starts)
...
def serve():
    ...
    and shuts down after idle_timeout seconds of inactivity. The persistent volume means
