...
class JobPostContent(Base):
    __tablename__ = 'job_post_content'
    
    job_post_id = Column(UUID(as_uuid=True), ForeignKey('job_post.id', ondelete='CASCADE'), primary_key=True)
    ...
    job_post = relationship("JobPost", back_populates="content")
