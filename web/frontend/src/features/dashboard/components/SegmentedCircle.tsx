...
export const SegmentedCircle: React.FC<CircleChartProps> = ({
    activeMatches, activeArc, cappedArc, hiddenArc, belowArc, circumference, radius,
}) => (
    <div className="relative h-24 w-24 flex-shrink-0 sm:h-28 sm:w-28">
        <svg className="h-full w-full -rotate-90" viewBox="0 0 96 96">
            ...
            <circle
                ...
                strokeLinecap="butt"
                className="transition-[stroke-dasharray] duration-700 ease-out"
                style={{ strokeDasharray: `${cappedArc} ${circumference - cappedArc}` }}
            />
            <circle
                cx="48"
                cy="48"
                ...
                strokeWidth="4"
                fill="none"
                strokeDashoffset={-(activeArc + cappedArc)}
                strokeLinecap="butt"
                className="transition-[stroke-dasharray] duration-700 ease-out"
            ...
            <circle
                ...
                strokeWidth="4"
                fill="none"
                strokeDashoffset={-(activeArc + cappedArc + hiddenArc)}
                strokeLinecap="butt"
                className="transition-[stroke-dasharray] duration-700 ease-out"
