...
describe('usePipelineEvents', () => {
    ...
    const renderConnectedHook = (taskId: string, options?: Parameters<typeof usePipelineEvents>[1]) => {
        const { result, rerender, unmount } = renderHook(
            ({ taskId }: { taskId: string | null }) => usePipelineEvents(taskId, options),
            { initialProps: { taskId: '' } }
        );
        rerender({ taskId });
    ...
    describe('status updates', () => {
        it('should update status on message', async () => {
            ...
            const statusData = createStatusData('running');
    ...
    describe('cleanup', () => {
        ...
        it('should not update state after unmount', async () => {
            ...
            await act(async () => {
                getLastEventSource().simulateMessage(createStatusData('running'));
            });
