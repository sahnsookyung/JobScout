...
This project is indexed by GitNexus as **JobScout** (6057 symbols, 16347 relationships, 267 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
