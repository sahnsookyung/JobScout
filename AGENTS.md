...
This project is indexed by GitNexus as **JobScout** (8362 symbols, 22359 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
