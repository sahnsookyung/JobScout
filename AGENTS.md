...
This project is indexed by GitNexus as **JobScout** (6101 symbols, 16506 relationships, 262 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
This project is indexed by GitNexus as **JobScout** (6097 symbols, 16509 relationships, 262 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
