...
This project is indexed by GitNexus as **JobScout** (7134 symbols, 19117 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
