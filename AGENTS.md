...
This project is indexed by GitNexus as **JobScout** (7020 symbols, 18746 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
