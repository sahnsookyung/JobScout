...
This project is indexed by GitNexus as **JobScout** (4209 symbols, 10927 relationships, 191 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
