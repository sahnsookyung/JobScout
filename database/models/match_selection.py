...
class MatchSelectionRun(Base):
    ...
    lifecycle_status = Column(Text, nullable=False, default="pending")
    ...
    fit_floor_used = Column(Numeric(5, 2), nullable=False, default=0)
    notification_fit_floor_used = Column(Numeric(5, 2), nullable=False, default=0)
    top_k_used = Column(Integer, nullable=False, default=0)
    candidate_pool_size = Column(Integer, nullable=False, default=0)
    selected_count = Column(Integer, nullable=False, default=0)
    alert_candidate_count = Column(Integer, nullable=False, default=0)
    resume_resolution_reason = Column(Text, nullable=False, default="")
...
class MatchSelectionItem(Base):
    ...
    fit_score_at_selection = Column(Numeric(5, 2), nullable=False, default=0)
    preference_score_at_selection = Column(Numeric(5, 4), nullable=True)
    job_similarity_at_selection = Column(Numeric(3, 2), nullable=False, default=0)
    required_coverage_at_selection = Column(Numeric(3, 2), nullable=False, default=0)
    ...
    ranking_snapshot = Column(JSONB, nullable=False, default=dict)
    created_at = Column(TIMESTAMP(timezone=True), nullable=False, server_default=UTC_NOW)
