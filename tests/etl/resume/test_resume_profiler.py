...
class TestResumeProfilerProfiling:
    ...
    def sample_resume_data(self):
        ...
        return {
            "sections": [
                ...
                {"title": "Skills", "items": [{"skills": "Python, Go, AWS"}]},
            ]
        }
    ...
    def test_profile_resume_without_store_returns_payload(
        ...
        profile, evidence_units, persistence_payload = profiler.profile_resume(
            sample_resume_data, resume_fingerprint="test-fp-123"
        )
    ...
    def test_profile_resume_with_store_persists(self, mock_ai_service, sample_resume_data):
    ...
    def test_profiler_can_be_created_without_repo(self, mock_ai_service):
    ...
    def test_save_resume_section_embeddings_synthesizes_summary_when_missing(self, mock_ai_service):
    ...
    def test_profile_resume_uses_pre_extracted_resume_without_llm_call(self, mock_ai_service):
...
class TestJobRepositoryAdapter:
    ...
    def test_adapter_wraps_get_call(self):
        ...
        mock_repo.get_resume_section_embeddings.assert_called_once_with(
            resume_fingerprint="test-fingerprint", section_type="experience"
        )
    ...
    def test_adapter_with_none_section_type(self):
        ...
        mock_repo.get_resume_section_embeddings.assert_called_once_with(
            resume_fingerprint="test-fingerprint", section_type=None
        )
...
class TestInMemoryEmbeddingStore:
    ...
    def test_filter_by_section_type(self):
        ...
        experience_sections = store.get_resume_section_embeddings("resume-123", "experience")
    ...
    def test_clear(self):
        ...
        store.save_resume_section_embeddings(
            "resume-123",
            [
                {
                    "section_type": "skills",
