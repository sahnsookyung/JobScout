...
def test_extract_highlights_evidence():
    ...
    exp_highlights = [
        ...
        if u.source_section == "Experience" and u.tags.get("type") == "highlight"
    ]
    ...
    proj_highlights = [
        u
        for u in evidence_units
        if u.source_section == "Projects" and u.tags.get("type") == "highlight"
    ]
    ...
    edu_highlights = [
        u
        for u in evidence_units
        if u.source_section == "Education" and u.tags.get("type") == "highlight"
    ]
