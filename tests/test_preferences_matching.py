...
from core.matcher_service import (
    MatcherService, MockMatcherService, ResumeEvidenceUnit,
    JobMatchPreliminary, PreferencesAlignmentScore
)
from core.scorer_service import ScoringService, ScoredJobMatch
...
class TestPreferencesMatching(unittest.TestCase):
    ...
    def test_03_location_match_avoided_location(self):
        ...
        preferences = self.sample_preferences.copy()
    ...
    def test_15_scoring_preferences_boost(self):
        ...
        # Calculate boost
        boost, details = self.scorer.calculate_preferences_boost(alignment)
    ...
    def test_16_scoring_preferences_penalty(self):
        ...
        print(f"  ✓ Total penalties: {penalties:.1f}")
    ...
    def test_17_scoring_without_preferences(self):
        ...
        boost, details = self.scorer.calculate_preferences_boost(None)
